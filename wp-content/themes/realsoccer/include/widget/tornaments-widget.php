 ...
 * Plugin Name: Goodlayers Upcoming Tornaments Widget

 * Plugin URI: http://goodlayers.com/

 * Description: A widget that shows upcoming events( Specified by category ).
	...
	class Goodlayers_Fixture_Result extends WP_Widget{
		...
		function __construct() {
			...
			parent::__construct(
				...
				__('Goodlayers Upcoming Tornaments','gdlr_translate'), 

				array('description' => __('A widget that shows upcoming tornaments', 'gdlr_translate')));  
